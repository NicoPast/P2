...
void PlayState::init() {
	...
	Vector2D p = { 20, 0 };
	Text* texto = t->addComponent<Text>("Morbidolorsapien, sollicitudin at lacinia eget, sodales vel tellus. Nullam condimentum nunc id lorem facilisis, id viverra est blandit. ", p, 200, game_->getGame()->getFontMngr()->getFont(Resources::ARIAL16));
