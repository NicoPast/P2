...
vector<Resources::AnimInfo> Resources::anims_{
	...
	{FadeInAnim, FadeSpriteSheet, 3,4,0,5,15,false},
	{FadeOutAnim, FadeSpriteSheet, 3,4,5,11,15,false},
	...
	{JardineraIdleAnim, JardineraIdle, 2,5,0,5,168,true},
	{GusIdleAnim, GusIdle, 2,4,0,5,168, true},
...
vector<Resources::ClueInfo> Resources::clues_ {
	...
	{"Papeles desordenados",
	 ...
	 { "Jard" + tildes_['i'] + "n de la entrada a la mansi" + tildes_['o'] + "n",
	  ...
	  Resources::TextureID::PolaroidEntrada}, 
	 ...
	 { "Despacho de Ernesto",
	  ...
	  Resources::TextureID::PolaroidDespacho }, 
	 ...
	 { "Habitaci" + tildes_['o'] + "n de " + tildes_['U'] + "rsula y Carlos",
	  ...
	  Resources::TextureID::PolaroidHabCapa },
	 ...
	 { "Habitaci" + tildes_['o'] + "n de Afur",
	  ...
	  Resources::TextureID::PolaroidHabAfur },
	 ...
	 { "Habitaci" + tildes_['o'] + "n de Ernesto",
	  ...
	  Resources::TextureID::PolaroidHabCapo }, 
	 ...
	 { "Caseta del jard" + tildes_['i'] + "n",
	  ...
	  Resources::TextureID::PolaroidCaseta },
	 ...
	 { "Habitaci" + tildes_['o'] + "n de Sabrina",
	  ...
	  Resources::TextureID::PolaroidHabSabrina },
